...
//                   );
//                 },
//                 icon: Icon(Icons.near_me_rounded, size: 26),
//               ),
//             ),
//           ],
//           centerTitle: true,
...
class PremiumClientProvider extends ChangeNotifier {
  bool loading = false;
  bool loadedOnce = false; // NEW FLAG
  List<Map<String, dynamic>> premiumClients = [];

  Future<void> fetchPremiumClients({bool forceRefresh = false}) async {
    // Do not fetch again if already loaded once unless user refreshes manually
          ...
          actions: [
            Padding(
              ...
              child: IconButton(
                ...
                icon: const Icon(Icons.near_me_rounded, size: 26),
              ),
            ),
          ],
          centerTitle: true,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    //////////////////////////////////////////////////////////////////////
                    /// GRID VIEW WITH REFRESH INDICATOR
                    //////////////////////////////////////////////////////////////////////
                    Expanded(
                      child: RefreshIndicator(
                        onRefresh: () async {
                          await provider.fetchPremiumClients(
                            forceRefresh: true,
                          );
                        },
                        child: GridView.builder(
