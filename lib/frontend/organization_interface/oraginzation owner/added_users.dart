...
//   /// Fetch the organization name of the currently logged-in owner
//   Future<void> fetchOrganizationName() async {
//     if (currentUserId == null) return;
//     final doc = await _firestore.collection('Users').doc(currentUserId).get();
//     if (doc.exists) {
//       setState(() {
//         organizationName = doc.data()?['Organization name'] ?? "Organization";
//       });
//     }
//   }
...
//   /// Copy both email and password to clipboard
...
//                     context,
//                     MaterialPageRoute(
//                       builder: (_) => CreateCredentialsScreen(key: UniqueKey()),
//                     ),
//                   );
//                 },
//               ),
