...
class OrganizationPaymentScreen extends StatelessWidget {
  // Assume we pass the organization name (or ID) here for display
  final String organizationName;
  const OrganizationPaymentScreen({super.key, required this.organizationName});
...
Navigator.push(
  context,
  MaterialPageRoute(
    builder: (context) => const OrganizationPaymentScreen(
