...
class _ModuleViewerScreenState extends State<ModuleViewerScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _progressAnimation = Tween<double>(begin: 0.0, end: initialProgress).animate(
          ...
          ElevatedButton(
            ...
            child: Row(
              ...
              children: [
                ...
                Icon(
                  _currentPage == _slides.length - 1 ? Icons.check_circle : Icons.arrow_forward_ios,
                  size: 16,
                  color: Colors.white,
                ),
              ],
    ...
    switch (type) {
      case 'text':
        return Padding(
          ...
          child: Text(
            data.toString(),
            style: TextStyle(fontSize: 18, height: 1.6, color: Colors.grey[800]),
          ),
        );
      case 'bullet_list':
        return Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: (data as List).map((item) => _buildBulletItem(item)).toList(),
          ),
        );
      case 'comparison':
        return Padding(
              ...
              child: Table(
                ...
                children: [
                  ...
                  TableRow(
                    ...
                    children: (data['headers'] as List).map((h) => Padding(
                  ...
                  // Rows
                  ...normalizedRows.map((row) => TableRow(
                    decoration: const BoxDecoration(color: Colors.white),
                    children: row.map((cell) => Padding(
                      padding: const EdgeInsets.all(12.0),
                      child: Text(cell.toString(), style: const TextStyle(fontSize: 15)),
                    )).toList(),
                  )).toList(),
                ],
              ),
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              item.toString(),
              style: TextStyle(fontSize: 17, height: 1.5, color: Colors.grey[800]),
            ),
          ),
        ],
      ),
        ...
        children: [
          ...
          ...items.map((item) => Padding(
            ...
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Icon(Icons.circle, size: 6, color: titleColor.withOpacity(0.7)),
