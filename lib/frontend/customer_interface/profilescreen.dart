...
//     final userdata = auth.fetchcustomer(context);
//     return Scaffold(
...
//   final String email;
//   // final auth = Authentication();
//   final userData = Authentication().fetchcustomer;
//   ProfileCard({super.key, required this.name, required this.email});

//   @override
//   Widget build(BuildContext context) {
//     return FutureBuilder(
//       future: Authentication().fetchcustomer(context),
...
//         } else {
//           final data = snaphot.data as Map<String, dynamic>;
//           return Container(
...
//                   ),
//                   onPressed: () {
//                     Authentication().updateCustomer(context);
//                   },
//                 ),
//               ],
//             ),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                await Authentication().updateCustomer(context, updatedData);
